...
c *********************************************************************
      ...
      subroutine h init ch5p(koeff,diag)
...
c ------ diagonale Komponenten des Hamilton-Operators -------
      ...
      call diagon ch5p (diag, dim, k zahl)
...
c ------------------------------------------------
      ...
      subroutine diagon ch5p (diag, dim, k zahl)
...
c -------------------------------------------------
      ...
      subroutine h ch5p(mode, teil, h psi, psi, dim, matrix, trafo, ort)
      use iso_c_binding
...
202         goto (1, 1, 35, 35) teil
c 202        goto (1, 1, 12, 12) teil
         read(5, *)
            stop
         else
            goto 1
