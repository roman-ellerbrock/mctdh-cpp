...
c Bestimmung der diagonalen Komponenten des Hamilton-Operators
      koeff(kzahl+1)=0
      call diagonch4frozen(diag,dim,kzahl)
...
c--------------------------------------------------------------
      ...
      subroutine diagonch4frozen(diag,dim,k zahl)
...
c#####################################################################
      ...
      subroutine hch4frozen (modesmall,teil,h psi,psi,dim,matrix,
     . trafo,ort)
      use iso_c_binding
      implicit      none

      integer       mode, modesmall, teil, dim, i, j
